...
use TotalBundle\Entity\Commentaire;
...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commentaires = $em->getRepository('TotalBundle:Commentaire')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('TotalBundle\Form\CommentaireType', $commentaire);
    ...
    {
        $deleteForm = $this->createDeleteForm($commentaire);
        $editForm = $this->createForm('TotalBundle\Form\CommentaireType', $commentaire);
